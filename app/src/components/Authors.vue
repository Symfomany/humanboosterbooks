<template>
   <div>
        ...
        <p v-for="authorData in authors" :key="authorData.id"> 
                    ...
                    {{ authorData.firstname }}  {{ authorData.lastname }} {{ authorData.id }}</p>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><button type="button" class="btn  btn-custom" data-bs-toggle="modal" data-bs-target="#exampleModal">
                          +</button></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="editor in editors_all_data" :key="editor.id">
                        ...
                        <td>
                          <a href="#">
                            <img class="icons_crud_editors" src="https://cdn-icons-png.flaticon.com/128/2312/2312022.png" alt="">
                          </a>

                          <a @click="supprimerEditeur" href="#">
                            <img class="icons_crud_editors" src="https://cdn-icons-png.flaticon.com/128/8134/8134370.png" alt="">
                          </a>
                        </td>
                      </tr>
                    </tbody>
