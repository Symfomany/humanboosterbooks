...
-- Fonctions
--
DROP FUNCTION IF EXISTS `convertLBS`$$
CREATE DEFINER=`root`@`localhost` FUNCTION `convertLBS` (`poid` INT(255)) RETURNS FLOAT  BEGIN
        RETURN (poid * 2.2); 
    END$$
...
INSERT INTO `commande` (`id`, `user_id`, `paiment_id`, `tva`, `created`, `quantity`, `status`) VALUES
(1, 1, 0, 19.5, '2023-06-19', 2, '1'),
...
INSERT INTO `comment` (`id`, `product_id`, `user_id`, `content`, `readed`, `created`) VALUES
(3, 1, 1, 'Blabla ...', 0, '2023-05-08'),
(4, 1, 1, 'Test', 1, '2022-05-08'),
(5, 1, 1, 'Bla bla etc...', 0, '2021-05-08'),
(6, 1, 1, 'OK', 1, '2023-06-08'),
(7, 1, 1, 'Test', 1, '2021-05-09'),
(8, 0, 0, 'qsdqsd', 0, '0000-00-00');
...
INSERT INTO `extras` (`id`, `poid`, `longueur`, `largeur`, `product_id`) VALUES
(1, 20, 30, 20, 1),
(11, 20, 10, 20, 2),
(12, 20, 10, 20, 0);
...
INSERT INTO `panier` (`id`, `user_id`, `promotion_id`, `created`) VALUES
(1, 1, 2, '2023-06-01 09:56:42');
...
(1, 'MacBook Apple Pro', NULL, 2, '2023-05-25 12:04:57', '2023-05-25 12:04:57', 1),
(2, 'Apple Mini', NULL, 4, '2023-05-25 12:04:57', '2023-05-25 12:04:57', 1);
...
INSERT INTO `product_tag` (`product_id`, `tag_id`, `createdAt`, `updatedAt`) VALUES
...
(1, 1, '2023-06-01 12:32:51', '2023-06-01 12:32:51');
...
(1, 'Boyer', 'François', 35, 'julien@taiwa.fr', 4.79807, 45.7311, '2023-05-25 13:36:02'),
(3, 'Test', 'Rémi', 21, '', 4.91285, 45.7047, '2023-05-25 13:37:15'),
(4, 'Adnane', '', 0, '', 5.36995, 43.2962, '2023-05-25 13:37:56'),
(5, 'Boyer', 'Florent', 0, '', 0, 0, '0000-00-00 00:00:00'),
(6, 'Boyer', 'Nicolas', 0, '', 0, 0, '0000-00-00 00:00:00'),
(7, 'Boyer', 'Nicolas', 0, '', 0, 0, '0000-00-00 00:00:00');
...
DELIMITER $$
CREATE TRIGGER `update_date` BEFORE UPDATE ON `user` FOR EACH ROW SET NEW.`date_updated` = NOW()
$$
DELIMITER ;
COMMIT;
